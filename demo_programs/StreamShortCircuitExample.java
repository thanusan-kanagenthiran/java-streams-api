...
public class StreamShortCircuitExample {
    ...
    public static void main(String[] args) {
        ...
        // findAny(): returns any element (deterministic in sequential, non-deterministic in parallel)
        ...
        // ❌ Avoid for I/O-bound tasks, ordered requirements, small datasets, or shared mutable state
    }
}